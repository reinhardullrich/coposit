...
{
    const matrix_integer matrix = parsers::fracessa_matrix_parser::parse("2#123456789012345678901234567890,-1,2");
...
{
    const matrix_integer matrix = parsers::fracessa_matrix_parser::parse("2#2.5E15,+1/8,1/2");
...
{
    const matrix_integer matrix = parsers::fracessa_matrix_parser::parse("5#1/2,-2.5e-1");
