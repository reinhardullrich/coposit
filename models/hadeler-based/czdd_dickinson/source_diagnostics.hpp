...
namespace coposit::czdd_dickinson_diagnostics {
...
#define COPOSIT_CZDD_DIAGNOSTICS(...) ::coposit::czdd_dickinson_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_CZDD_DIAGNOSTICS(...) ((void)0)
