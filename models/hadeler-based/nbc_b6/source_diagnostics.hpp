...
namespace coposit::nbc_b6_diagnostics {
...
#define COPOSIT_NBC_B6_DIAGNOSTICS(...) ::coposit::nbc_b6_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_NBC_B6_DIAGNOSTICS(...) ((void)0)
