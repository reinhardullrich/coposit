...
namespace coposit::sat_a1_diagnostics {
...
#define COPOSIT_SAT_A1_DIAGNOSTICS(...) ::coposit::sat_a1_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_SAT_A1_DIAGNOSTICS(...) ((void)0)
