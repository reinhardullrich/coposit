...
namespace coposit::sat_a5_diagnostics {
...
#define COPOSIT_SAT_A5_DIAGNOSTICS(...) ::coposit::sat_a5_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_SAT_A5_DIAGNOSTICS(...) ((void)0)
