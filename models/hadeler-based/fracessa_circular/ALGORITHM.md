...
When diagnostics reporting is enabled, the model publishes its current support cardinality, emitted bracelet representatives, bracelets
...
$2^n-1$ raw supports. Disabled diagnostics performs no atomic telemetry operations.
