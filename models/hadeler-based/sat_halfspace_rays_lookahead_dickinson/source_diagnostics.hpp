...
namespace coposit::sat_halfspace_rays_lookahead_dickinson_diagnostics {
...
#define COPOSIT_SAT_HALFSPACE_RAYS_LOOKAHEAD_DIAGNOSTICS(...) ::coposit::sat_halfspace_rays_lookahead_dickinson_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_SAT_HALFSPACE_RAYS_LOOKAHEAD_DIAGNOSTICS(...) ((void)0)
