...
namespace coposit::improved_nbc_x8_diagnostics {
...
#define COPOSIT_IMPROVED_NBC_X8_DIAGNOSTICS(...) ::coposit::improved_nbc_x8_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_IMPROVED_NBC_X8_DIAGNOSTICS(...) ((void)0)
