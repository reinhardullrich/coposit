...
“BDD” identifies the sole mathematical change from Dickinson 2019: Dickinson intervals are compiled into a BDD set-family
representation. The model began as a complete copy of `models/hadeler-based/zdd_dickinson`; its principal solve,
