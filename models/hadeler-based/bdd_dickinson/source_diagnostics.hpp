...
#ifdef COPOSIT_BDD_DICKINSON_TESTING

#include <cstddef>
#include <string_view>
#include <vector>

namespace coposit::bdd_dickinson_diagnostics {
...
#define COPOSIT_BDD_DIAGNOSTICS(...) ::coposit::bdd_dickinson_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_BDD_DIAGNOSTICS(...) ((void)0)
