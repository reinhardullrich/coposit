...
namespace coposit::dual_frontier_nbc_diagnostics {
...
#define COPOSIT_DUAL_FRONTIER_NBC_DIAGNOSTICS(...) ::coposit::dual_frontier_nbc_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_DUAL_FRONTIER_NBC_DIAGNOSTICS(...) ((void)0)
