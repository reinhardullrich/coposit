...
namespace coposit::sat_c4_diagnostics {
...
#define COPOSIT_SAT_C4_DIAGNOSTICS(...) ::coposit::sat_c4_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_SAT_C4_DIAGNOSTICS(...) ((void)0)
