...
namespace coposit::improved_nbc_b9_diagnostics {
...
#define COPOSIT_IMPROVED_NBC_B9_DIAGNOSTICS(...) ::coposit::improved_nbc_b9_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_IMPROVED_NBC_B9_DIAGNOSTICS(...) ((void)0)
