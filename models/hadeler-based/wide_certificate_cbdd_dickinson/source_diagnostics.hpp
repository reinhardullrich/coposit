...
namespace coposit::cbdd_dickinson_diagnostics {
...
#define COPOSIT_CBDD_DIAGNOSTICS(...) ::coposit::cbdd_dickinson_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_CBDD_DIAGNOSTICS(...) ((void)0)
