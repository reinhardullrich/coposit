...
namespace coposit::sat_a2_diagnostics {
...
#define COPOSIT_SAT_A2_DIAGNOSTICS(...) ::coposit::sat_a2_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_SAT_A2_DIAGNOSTICS(...) ((void)0)
