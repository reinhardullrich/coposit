...
namespace coposit::sat_dickinson_diagnostics {
...
#define COPOSIT_SAT_DIAGNOSTICS(...) ::coposit::sat_dickinson_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_SAT_DIAGNOSTICS(...) ((void)0)
