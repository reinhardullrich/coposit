...
| Boolean-lattice representations | `bdd_dickinson`, `zdd_dickinson`, `cbdd_dickinson`, `cbdd_halfspace_dickinson`, `upper_endpoint_cbdd_dickinson`, `cbdd_dickinson_improved_1`, `wide_certificate_cbdd_dickinson`, `multithreaded_cbdd_dickinson`, `czdd_dickinson`, `sat_dickinson`, `sat_halfspace_dickinson`, `sat_halfspace_lp_dickinson`, `sat_halfspace_milp_dickinson`, `sat_halfspace_rays_lookahead_dickinson`, `sat_halfspace_rays_wide_dickinson`, `wide_certificate_sat_dickinson`, `xxx`, `xxx_two`, `clingo_dickinson`, `clingo_halfspace_dickinson` |
