...
namespace coposit::zdd_dickinson_diagnostics {
...
#define COPOSIT_ZDD_DIAGNOSTICS(...) ::coposit::zdd_dickinson_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_ZDD_DIAGNOSTICS(...) ((void)0)
