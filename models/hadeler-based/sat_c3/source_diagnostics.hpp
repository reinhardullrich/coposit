...
namespace coposit::sat_c3_diagnostics {
...
#define COPOSIT_SAT_C3_DIAGNOSTICS(...) ::coposit::sat_c3_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_SAT_C3_DIAGNOSTICS(...) ((void)0)
