...
namespace coposit::sat_b2_diagnostics {
...
#define COPOSIT_SAT_B2_DIAGNOSTICS(...) ::coposit::sat_b2_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_SAT_B2_DIAGNOSTICS(...) ((void)0)
