...
namespace coposit::sat_b1_diagnostics {
...
#define COPOSIT_SAT_B1_DIAGNOSTICS(...) ::coposit::sat_b1_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_SAT_B1_DIAGNOSTICS(...) ((void)0)
