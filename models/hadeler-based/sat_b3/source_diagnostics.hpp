...
namespace coposit::sat_b3_diagnostics {
...
#define COPOSIT_SAT_B3_DIAGNOSTICS(...) ::coposit::sat_b3_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_SAT_B3_DIAGNOSTICS(...) ((void)0)
