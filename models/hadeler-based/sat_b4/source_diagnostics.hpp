...
namespace coposit::sat_b4_diagnostics {
...
#define COPOSIT_SAT_B4_DIAGNOSTICS(...) ::coposit::sat_b4_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_SAT_B4_DIAGNOSTICS(...) ((void)0)
