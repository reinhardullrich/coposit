...
namespace coposit::interval_supports_g3_diagnostics {
...
#define COPOSIT_INTERVAL_SUPPORTS_G3_DIAGNOSTICS(...) ::coposit::interval_supports_g3_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_INTERVAL_SUPPORTS_G3_DIAGNOSTICS(...) ((void)0)
