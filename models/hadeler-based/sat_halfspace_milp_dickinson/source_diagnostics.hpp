...
namespace coposit::sat_halfspace_milp_dickinson_diagnostics {
...
#define COPOSIT_SAT_HALFSPACE_MILP_DIAGNOSTICS(...) ::coposit::sat_halfspace_milp_dickinson_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_SAT_HALFSPACE_MILP_DIAGNOSTICS(...) ((void)0)
