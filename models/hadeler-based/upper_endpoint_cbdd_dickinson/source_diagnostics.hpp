...
namespace coposit::upper_endpoint_cbdd_dickinson_diagnostics {
...
#define COPOSIT_UPPER_ENDPOINT_CBDD_DIAGNOSTICS(...) \
    ::coposit::upper_endpoint_cbdd_dickinson_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_UPPER_ENDPOINT_CBDD_DIAGNOSTICS(...) ((void)0)
