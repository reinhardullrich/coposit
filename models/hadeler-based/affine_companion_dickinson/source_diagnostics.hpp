...
namespace coposit::affine_companion_dickinson_diagnostics {
...
#define COPOSIT_AFFINE_COMPANION_DICKINSON_DIAGNOSTICS(...) ::coposit::affine_companion_dickinson_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_AFFINE_COMPANION_DICKINSON_DIAGNOSTICS(...) ((void)0)
