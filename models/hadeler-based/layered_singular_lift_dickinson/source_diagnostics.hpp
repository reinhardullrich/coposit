...
namespace coposit::layered_singular_lift_dickinson_diagnostics {
...
#define COPOSIT_LAYERED_LIFT_DIAGNOSTICS(...) ::coposit::layered_singular_lift_dickinson_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_LAYERED_LIFT_DIAGNOSTICS(...) ((void)0)
