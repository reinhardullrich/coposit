...
TEST(SatHalfspaceLpDickinsonTest, FullCeilingLpSupersedesTheCombinedRayWhenItCan)
{
    ...
    EXPECT_EQ(model::sat_halfspace_lp_full_ceiling_hit_count_for_testing(), 1U);
    EXPECT_EQ(model::sat_halfspace_rays_combined_ray_sweep_count_for_testing(), 0U);
}
