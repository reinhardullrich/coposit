...
namespace coposit::interval_recursive_dickinson_diagnostics {
...
#define COPOSIT_INTERVAL_RECURSIVE_DIAGNOSTICS(...) ::coposit::interval_recursive_dickinson_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_INTERVAL_RECURSIVE_DIAGNOSTICS(...) ((void)0)
