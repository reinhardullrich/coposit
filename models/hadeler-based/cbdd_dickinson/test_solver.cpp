...
TEST(CbddDickinsonTest, PreservesStrictDickinsonDecisions)
{
...
TEST(CbddDickinsonTest, DistinguishesOrdinaryFromStrictCopositivity)
{
...
TEST(CbddDickinsonTest, ClassifiesBothPredicatesInOneTraversal)
{
...
TEST(CbddDickinsonTest, SubtractsTheUnionOfBoundedIntervals)
{
...
TEST(CbddDickinsonTest, RepresentsAWholeDownsetWithAnEmptyLowerEndpoint)
{
...
TEST(CbddDickinsonTest, MatchesBruteForceForEveryPairOfFourDimensionalIntervals)
{
...
TEST(CbddDickinsonTest, PublishesCertificateFreeIndexAndUpperSizeDistributionOnlyWithDiagnostics)
{
...
TEST(CbddDickinsonTest, KeepsPackedSupportsBeyondOneWord)
{
...
TEST(CbddDickinsonTest, CooperativeTimeoutEscapesDiagramOperations)
{
    request_timeout();
