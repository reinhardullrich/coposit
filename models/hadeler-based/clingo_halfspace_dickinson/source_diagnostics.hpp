...
namespace coposit::clingo_halfspace_dickinson_diagnostics {
...
#define COPOSIT_CLINGO_HALFSPACE_DIAGNOSTICS(...) ::coposit::clingo_halfspace_dickinson_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_CLINGO_HALFSPACE_DIAGNOSTICS(...) ((void)0)
