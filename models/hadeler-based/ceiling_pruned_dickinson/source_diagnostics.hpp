...
namespace coposit::ceiling_pruned_dickinson_diagnostics {
...
#define COPOSIT_CEILING_DICKINSON_DIAGNOSTICS(...) ::coposit::ceiling_pruned_dickinson_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_CEILING_DICKINSON_DIAGNOSTICS(...) ((void)0)
