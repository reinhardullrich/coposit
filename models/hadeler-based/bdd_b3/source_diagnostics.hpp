...
namespace coposit::bdd_b3_diagnostics {
...
#define COPOSIT_BDD_B3_DIAGNOSTICS(...) ::coposit::bdd_b3_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_BDD_B3_DIAGNOSTICS(...) ((void)0)
