...
namespace coposit::sat_a3_diagnostics {
...
#define COPOSIT_SAT_A3_DIAGNOSTICS(...) ::coposit::sat_a3_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_SAT_A3_DIAGNOSTICS(...) ((void)0)
