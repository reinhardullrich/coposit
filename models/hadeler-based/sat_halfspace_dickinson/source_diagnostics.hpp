...
namespace coposit::sat_halfspace_dickinson_diagnostics {
...
#define COPOSIT_SAT_HALFSPACE_DIAGNOSTICS(...) ::coposit::sat_halfspace_dickinson_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_SAT_HALFSPACE_DIAGNOSTICS(...) ((void)0)
