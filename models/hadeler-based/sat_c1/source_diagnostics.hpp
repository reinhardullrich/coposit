...
namespace coposit::sat_c1_diagnostics {
...
#define COPOSIT_SAT_C1_DIAGNOSTICS(...) ::coposit::sat_c1_diagnostics::record(__VA_ARGS__)

#else

#define COPOSIT_SAT_C1_DIAGNOSTICS(...) ((void)0)
