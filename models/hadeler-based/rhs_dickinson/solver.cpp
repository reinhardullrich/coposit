...
public:
    rhs_dickinson_checker(size_t dimension, copositivity_mode mode)
    ...
    rhs_dickinson_checker(size_t dimension, copositivity_classification& classification)
        : support_context_(dimension)
        , factorization_(dimension)
        , base_product_(dimension)
        , direction_product_(dimension)
...
private:
    ...
    bool process_subset(const matrix_integer& matrix, const std::vector<size_t>& indices)
    {
        ...
        if (all_nonnegative && !accept_boundary()) return false;
...
bool solve(const matrix_integer& matrix, copositivity_mode mode)
{
    ...
    rhs_dickinson_checker checker(dimension, mode);
...
copositivity_classification classify(const matrix_integer& matrix)
{
    ...
    rhs_dickinson_checker checker(dimension, result);
