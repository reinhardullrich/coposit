...
The exact maintained reconstruction is documented in [`../copomatrix_2011/ALGORITHM.md`](../copomatrix_2011/ALGORITHM.md).
...
- the maintained [`../dutour_2018/ALGORITHM.md`](../dutour_2018/ALGORITHM.md).
...
The public boundary checks that the matrix is nonempty, square, and exactly symmetric. Invalid input throws `std::invalid_argument`.
A cooperative timeout remains unresolved and is never returned as `false`.
