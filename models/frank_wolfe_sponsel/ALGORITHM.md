...
[`sponsel_2012`](../sponsel_2012/ALGORITHM.md). The authoritative implementation is [`solver.cpp`](solver.cpp).
...
then $y^TGy>0$ for every nonzero $y\geq0$, so the complete node is accepted. The published ordinary-copositivity framework allows
