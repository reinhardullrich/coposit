...
#ifdef COPOSIT_BASELINE_SOURCE_TRACE

#include <cstddef>
#include <string_view>
#include <vector>

namespace coposit::baseline_source_trace {
...
#define COPOSIT_SOURCE_TRACE(...) ::coposit::baseline_source_trace::record(__VA_ARGS__)

#else

#define COPOSIT_SOURCE_TRACE(...) ((void)0)
