...
TEST(Safi2021ModelTest, RejectsInvalidMatrixShapes)
{
...
TEST(Safi2021ModelTest, DecidesOrdinaryCopositivity)
{
    ...
    EXPECT_FALSE(model::solve(symmetric_matrix(2, {0, -1, 1}), ordinary));
}
