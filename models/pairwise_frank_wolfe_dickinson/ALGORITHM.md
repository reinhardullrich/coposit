...
10. If no witness was verified, run the maintained strict-only Dickinson traversal.
11. Return Dickinson's strict-copositivity result.
...
$2^{40}$ reconstruction, direct witnesses, and the maintained strict-only Dickinson fallback.
...
supports. Once generated, that zero terminates the strict-only traversal immediately.
