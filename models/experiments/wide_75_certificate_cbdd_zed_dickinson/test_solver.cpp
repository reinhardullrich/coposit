...
TEST(WideCertificateCbddZedDickinsonTest, UsesOnlyCertificatesWiderThanThreeQuartersOfRemainingIndices)
{
    ...
    EXPECT_FALSE(model::wide_certificate_cbdd_uses_full_interval(70, 2, 51));
    EXPECT_TRUE(model::wide_certificate_cbdd_uses_full_interval(70, 2, 52));
}
