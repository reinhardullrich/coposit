...
namespace coposit::cbdd_zed_dickinson_trace {
...
#define COPOSIT_CBDD_ZED_TRACE(...) ::coposit::cbdd_zed_dickinson_trace::record(__VA_ARGS__)

#else

#define COPOSIT_CBDD_ZED_TRACE(...) ((void)0)
