...
namespace coposit::interval_bdd_dickinson_trace {
...
#define COPOSIT_INTERVAL_BDD_TRACE(...) ::coposit::interval_bdd_dickinson_trace::record(__VA_ARGS__)

#else

#define COPOSIT_INTERVAL_BDD_TRACE(...) ((void)0)
