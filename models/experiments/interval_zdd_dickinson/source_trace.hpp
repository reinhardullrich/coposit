...
namespace coposit::interval_zdd_dickinson_trace {
...
#define COPOSIT_INTERVAL_ZDD_TRACE(...) ::coposit::interval_zdd_dickinson_trace::record(__VA_ARGS__)

#else

#define COPOSIT_INTERVAL_ZDD_TRACE(...) ((void)0)
