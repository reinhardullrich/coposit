...
namespace coposit::bdd_zed_dickinson_trace {
...
#define COPOSIT_BDD_ZED_TRACE(...) ::coposit::bdd_zed_dickinson_trace::record(__VA_ARGS__)

#else

#define COPOSIT_BDD_ZED_TRACE(...) ((void)0)
