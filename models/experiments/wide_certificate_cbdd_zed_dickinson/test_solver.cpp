...
bool wide_certificate_cbdd_uses_full_interval(size_t dimension, size_t free_indices) noexcept;
...
TEST(WideCertificateCbddZedDickinsonTest, UsesOnlyCertificatesWiderThanHalfTheDimension)
{
    EXPECT_FALSE(model::wide_certificate_cbdd_uses_full_interval(70, 35));
    EXPECT_TRUE(model::wide_certificate_cbdd_uses_full_interval(70, 36));
    EXPECT_FALSE(model::wide_certificate_cbdd_uses_full_interval(5, 2));
    EXPECT_TRUE(model::wide_certificate_cbdd_uses_full_interval(5, 3));
}
