...
namespace coposit::dense_bitset_dickinson_trace {
...
#define COPOSIT_DENSE_BITSET_TRACE(...) ::coposit::dense_bitset_dickinson_trace::record(__VA_ARGS__)

#else

#define COPOSIT_DENSE_BITSET_TRACE(...) ((void)0)
