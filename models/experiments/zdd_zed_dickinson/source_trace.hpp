...
namespace coposit::zdd_zed_dickinson_trace {
...
#define COPOSIT_ZDD_ZED_TRACE(...) ::coposit::zdd_zed_dickinson_trace::record(__VA_ARGS__)

#else

#define COPOSIT_ZDD_ZED_TRACE(...) ((void)0)
