...
namespace coposit::czdd_zed_dickinson_trace {
...
#define COPOSIT_CZDD_ZED_TRACE(...) ::coposit::czdd_zed_dickinson_trace::record(__VA_ARGS__)

#else

#define COPOSIT_CZDD_ZED_TRACE(...) ((void)0)
