...
TEST(CbddZedDickinsonTest, DistinguishesOrdinaryFromStrictCopositivity)
{
...
TEST(CbddZedDickinsonTest, PublishesCertificateFreeIndexAndUpperSizeDistributionOnlyWithProgress)
{
