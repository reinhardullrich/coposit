...
TEST(WideCertificateCbddZedDickinsonTest, UsesOnlyCertificatesWiderThanNinetyPercentOfRemainingIndices)
{
    ...
    EXPECT_FALSE(model::wide_certificate_cbdd_uses_full_interval(50, 3, 42));
    EXPECT_TRUE(model::wide_certificate_cbdd_uses_full_interval(50, 3, 43));
}
