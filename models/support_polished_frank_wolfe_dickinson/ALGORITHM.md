...
maintained strict-only Dickinson traversal. The two front-end tests can add early rejections, but neither can add a false rejection or a
false acceptance.
...
change. The fallback remains a self-contained copy of the maintained [`dickinson_2019`](../dickinson_2019/ALGORITHM.md) model. The
...
11. If polishing finds no exact witness, run the maintained strict-only Dickinson subset traversal.
12. Return Dickinson's exact strict-copositivity result.
