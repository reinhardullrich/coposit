...
ALTER TABLE results RENAME TO results_without_parse_error_status;
...
INSERT INTO results
SELECT * FROM results_without_parse_error_status;

DROP TABLE results_without_parse_error_status;
